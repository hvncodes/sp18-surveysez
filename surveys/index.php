<?php
/**
 * demo_list_pager.php along with survey_view.php provides a sample web application
 *
...
<p>Use <b>demo_list_pager.php</b> and <b>survey_view.php</b> as a starting point for building your own List/View web application!</p> 
<?php
...
{#records exist - process
	...
	{# process each row
         ...
         echo '</div>'; # <i>only</i> <font color="red">$' . number_format((float)$row['Price'],2)  . '</font>
	}
